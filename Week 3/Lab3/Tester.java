...
*/
	...
	public static void testPart3a() {
		System.out.println("Part 3a - Writing tests - Student card test on the door.");
		System.out.println("======");
		
		System.out.println("* Creating a new door to the Research Labs");
		Door door = new Door();
		door.setRoomName("Research Labs");
		System.out.println();
		
		System.out.println("* Adding a lock to the door");
		CardLock lock = new CardLock();
		door.attachLock(lock);
		System.out.println();
		
		System.out.println("* Creating a student smart card.");
		SmartCard studentCard = new SmartCard("Anna Undergrad");
		System.out.println();
		
		System.out.println("* Trying to open the door using their card.");
		System.out.println();
		lock.swipeCard(studentCard);
		door.openDoor();
		System.out.println();
		
	}
	
	public static void testPart3b() {
		System.out.println("Part 3 - Writing tests - Staff card test on the door.");
		System.out.println("======");
		
		System.out.println("* Creating a new door to the Research Labs 2");
		Door door = new Door();
		door.setRoomName("Research Labs 2");
		System.out.println();
		...
		System.out.println("* Creating a staff smart card.");
		SmartCard staffCard = new SmartCard("Dr. Bob Lecturer");
	...
	public static void testPart3c() {
		System.out.println("Part 3 - Writing tests - Opening the door before adding a lock.");
		System.out.println("======");
		
		System.out.println("* Creating a new door to the Unlocked Room");
		Door door = new Door();
		door.setRoomName("Unlocked Room");
		System.out.println();
